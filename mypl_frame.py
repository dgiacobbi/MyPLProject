...
def SETL():
    return VMInstr(OpCode.SETL)

def MAX():
    return VMInstr(OpCode.MAX)

def MIN():
    return VMInstr(OpCode.MIN)

def CLEAR():
    return VMInstr(OpCode.CLEAR)

def POPL():
    return VMInstr(OpCode.POPL)

def APP():
    return VMInstr(OpCode.APP)
