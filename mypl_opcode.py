...
OpCode = Enum('OpCode', [
    ...
    # list
    'ALLOCL',  # allocate list object, push oid x
    'MAX',     # pop oid x, push max(x) onto stack, 
    'MIN',     # pop oid x, push min(x) onto stack, 
    'CLEAR',   # pop oid x, push clear list, 
    'POPL',     # pop oid x, pop last element of list
    'APP',     # pop value x, pop oid y, append x to list y
])
