...
@dataclass
class ListRValue(RValue):
    fun_name: Token
    list_path: List[VarRef]
    def accept(self, visitor):
        visitor.visit_list_rvalue(self)
...
@dataclass
class ListFunStmt(Stmt):
    function: Token
    list_path: List[VarRef]
    append_item: SimpleRValue
    def accept(self, visitor):
        visitor.visit_list_fun_stmt(self)
